...
/**
 * <p>
 * A comparator that emulates the "intuitive" sorting used by Windows Explorer. The rules are as
 * follows:
 * </p>
 *
 * <ul>
 * <li>Any sequence of one or more digits is treated as an atomic unit, a number. When these number
 * units are matched up, they're compared according to their respective numeric values. If they're
 * numerically equal, but one has more leading zeroes than the other, the longer sequence is
 * considered larger.</li>
 ...
 *
 * <p>
 * Explorer's sort order for punctuation characters is not quite the same as their ASCII order.
 * Also, some characters aren't allowed in file names, so I don't know how they would be sorted.
 * This class just sorts them all according to their ASCII values.
 * </p>
 *
 * <p>
